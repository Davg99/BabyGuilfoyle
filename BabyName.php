...
if (mysqli_connect_error()) {
    ...
    die ("There was an error connecting to the database");
            ...
            if (mysqli_query($link, $query)) {
                ...
                echo "<script>alert('We've recieved your informtation! <br/>  Thanks so much for helping us pick a name...');</script>";
...
<input id="FavoriteBeer" name="beer" type="text" placeholder = "Which beer will he celebrate the summit with?"/><br />
